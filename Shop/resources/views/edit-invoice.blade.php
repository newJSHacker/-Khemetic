                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form {{ route('edit-invoice', $inv->id)}} method="post" enctype="multipart/form-data" class="form-horizontal">
                                {!! csrf_field() !!}
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="item_code" id="select" class="form-control items">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" value="{{$inv->item_qty}}" name="item_qty" placeholder="Text" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="price" name="item_price" value="{{$inv->item_price}}"   placeholder="Text" class="form-control price">
                                    </div>
                                </div>
