                ...
                <div class="col-xl-10 col-lg-9 col-xl-80per">
                    ...
                    <div class="product-listing">
                        <div class="inner-listing">
                            <div class="product-listing" id="list">
                                <div class="inner-listing">
                                    <div class="row">
                                        @foreach($i as $items)
                                            <div class="col-md-4 col-6 item-width mb-30">
                                                <div class="product-item">
                                                    <div class="" style=""><a
                                                            href="{{route('product-details',$items->item_code) }}">
                                                            <img src="{{$items->item_image}}" style="height:250px;"
                                                                 alt="Stylexpo"> </a>
                                                            ...
                                                            <div class="detail-inner-left align-center">
                                                                <ul>
                                                                    <li class="pro-cart-icon">
                                                                        <form method="get"
                                                                              action="{{route('cart',$items->item_code)}}">
                                                    ...
                                                    <div class="product-item-details">
                                                        <div class="product-item-name"><a
                                                                href="{{route('product-details',$items->item_code) }}">{{$items->item_description}}</a>
                                                        </div>
                                                        {{--<div class="price-box"> <span class="price">PKR {{$items->item_current_selling_price}}</span></div>--}}
                                                        <div class="price-box"><span
                                                                class="price">{!! getSymboleDevise() !!} {{$items->new_price}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
