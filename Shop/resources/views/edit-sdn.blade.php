                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form  action="{{ route('edit-sdn',$sdn->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                {!! csrf_field() !!}
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="sales_delivered_item" id="select" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="sales_delivered_qty" placeholder="Text" class="form-control">
