                ...
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <a href="add-items"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    ...
                                    <td>
                                        <div class="table-data-feature">
                                            ...
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                <a class="createe-modal nav-link"  href="{{route('inventory.delete',$i->id) }}"> <i class="zmdi zmdi-delete"></i></a>
                                            </button>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $('#c-name').append('<img class="img" src="'+ t + '" /><button ><a href="inventory/deleteimg/' + u + '" > <i class="zmdi zmdi-delete btn"></i></a></button>');
                        }
                        $('#updated').modal('show');
                    }
                });
