...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>" style="color: #000;">Login</a></li>
                        <?php else: ?>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle nav-link-align-btn" data-toggle="dropdown" role="button"
                                ...
                                <img src="<?php echo e(asset('01-progress.gif')); ?>" data-src="https://png.icons8.com/dusk/200/000000/user.png"
                                    alt="Profile Picture" style="vertical-align: middle;border-style: none;border-radius: 50%;width: 30px;height: 30px;">
                                <?php else: ?>
                                <img src="<?php echo e(asset('01-progress.gif')); ?>" data-src="https://png.icons8.com/dusk/200/000000/user-female.png"
                                    alt="Profile Picture" style="vertical-align: middle;border-style: none;border-radius: 50%;width: 30px;height: 30px;">
                                <?php endif; ?>
                                <?php endif; ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?php echo e(url('user/'.Auth::user()->student_code)); ?>">Profile</a>
                                </li>
                                <?php endif; ?>
                                <li>
                                    <a href="<?php echo e(url('user/config/change_password')); ?>">Change Password</a>
                                </li>
                                <?php if(env('APP_ENV') != 'production'): ?>
                                <li>
                                    <a href="<?php echo e(url('user/config/impersonate')); ?>">
                                        <?php echo e(app('impersonate')->isImpersonating() ? 'Leave Impersonation' : 'Impersonate'); ?>
    ...
    <link href="<?php echo e(asset('css/flatly.bootstrap-3.3.7.min.css')); ?>" rel="stylesheet" id="bootswatch-print-id">
    <link href="<?php echo e(asset('css/dataTables-1.10.16.bootstrap.min.css')); ?>" rel="stylesheet">
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('<?php echo e(asset('css/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2')); ?>') format('woff2');
        }
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('js/bootstrap-3.3.7.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/dataTables-1.10.16.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/dataTables-1.10.16.bootstrap.min.js')); ?>"></script>
